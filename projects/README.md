...
| **Proyecto** (trabajo propio) | `projects/{name}/` | Código, docs, bitácora, assets del proyecto |

## Convención de creación

Al iniciar un nuevo proyecto:

1. Copiar `projects/_template/` → `projects/{nombre-proyecto}/`
2. Completar `projects/{nombre-proyecto}/README.md` con el brief
